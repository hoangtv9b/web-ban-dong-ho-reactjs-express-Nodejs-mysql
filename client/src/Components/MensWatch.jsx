                ...
                <div className="container">
                    <div className="row">
                        <Breadcrumb>
                            ...
                            <BreadcrumbItem link="/dong-ho-nam" label="đồng hồ nam" />
                        </Breadcrumb>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-md-9">
                            <div className="top-list-product d-flex align-items-center ">
                                <div className="col-sm-5 d-flex align-items-center">
                                    <h2 className="trade-mark-title">ĐỒNG HỒ NAM</h2><span className="count-product-text">(15 Sản phẩm)</span>
                                </div>
                            ...
                            <div className="list-product row my-3">
                                <ProductShow product={product} category={"Đồng hồ nam"} quantity={0} />
                            </div>
                        </div>
                    </div>
                </div>
